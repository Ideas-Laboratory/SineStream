...
备注:
*/
function numContainsByID(num, value_id, id = "id", log = false) {
    if (num === undefined) {
...
备注:
*/
function getNumElementIndex(num, value) {
    //测试变量类型
...
备注:
*/
function getNumElementIndexByID(num, IDValue, id = 'id') {
    //测试变量类型
...
备注:
*/
function getNumElementByID(num, IDValue, id = 'id') {
    //测试变量类型
    // console.log(typeof(num[0][id]));
    // console.log(typeof(IDValue));
    for (let i = 0; i < num.length; i++) {
...
备注:
*/
function getNumElementsByAttribute(num, attrValue, attr) {
    let result = [];
    for (let i = 0; i < num.length; i++) {
...
备注:
*/
function turnHighDimensionArraytoOneDimensionArray(array) {
    if (array === undefined) {
...
备注:
*/
function getArray3D(lenA, lenB, lenC, value = 0) {
...
备注:
*/
function getStandardDeviation(num) {
    if (num.length === 0) {
...
备注:
*/
function getNumOutlierByQuantiles(num, Q1 = undefined, Q2 = undefined, Q3 = undefined) {
    if (num.length === 0) {
        console.log('ERROR:::Function:getQuantiles. the array\'s length is 0');
        return -1;
    }
...
function A_Copy_Of(ele) {
    // let res ;
    // try{
    //     res = JSON.parse(JSON.stringify(ele))
    // }catch(e){
    //     console.log(e);
    //     return 
    // }
